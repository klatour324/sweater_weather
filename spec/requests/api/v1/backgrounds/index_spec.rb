  ...
  describe 'happy path' do
    it 'sends an image for the background for a given location' do
      VCR.use_cassette('background_image_request') do
        ...
        expect(result[:data][:attributes][:credit]).to have_key(:source)
        expect(result[:data][:attributes][:credit][:source]).to be_a(String)
        expect(result[:data][:attributes][:credit]).to have_key(:author)
        expect(result[:data][:attributes][:credit][:author]).to be_a(String)
        expect(result[:data][:attributes][:credit]).to have_key(:author_profile)
        expect(result[:data][:attributes][:credit][:author_profile]).to be_a(String)
